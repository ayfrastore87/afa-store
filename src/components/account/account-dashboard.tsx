...
type Order = { id: string; invoice: string; createdAt: string; updatedAt?: string; subtotal: number; shipping: number; discount?: number; total: number; voucher?: string | null; status: string; paymentStatus?: string; courier?: string | null; trackingNumber?: string | null; paidAt?: string | null; processedAt?: string | null; packedAt?: string | null; shippedAt?: string | null; completedAt?: string | null; cancelledAt?: string | null; items: OrderItem[] };
