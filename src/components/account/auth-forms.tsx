...
export function AuthForm({ mode, token }: { mode: Mode; token?: string }) {
    ...
    const submit = async (event: React.FormEvent) => {
        ...
        if (mode === "login") window.location.href = "/account";
        if (mode === "register") window.location.href = "/login";
