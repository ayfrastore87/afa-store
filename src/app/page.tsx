...
export default function Home() {
  ...
  const loadProducts = useCallback(() => {
    ...
    fetchProducts()
      .then(setProducts)
      .catch(() => setProductsError("Produk belum dapat dimuat. Silakan coba lagi."))
