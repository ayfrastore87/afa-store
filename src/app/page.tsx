...
export default function Home() {
  ...
  const scrollToSection = (target: { current: HTMLElement | null }) => target.current?.scrollIntoView({ behavior: "smooth", block: "start" });
  ...
  const heroTargetRef = katalogRef;
