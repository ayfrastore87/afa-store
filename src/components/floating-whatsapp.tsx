...
export default function FloatingWhatsApp({ className = "" }: FloatingWhatsAppProps) {
    ...
    return (
        <a
            ...
            className={`floating-whatsapp fixed bottom-[88px] right-[18px] z-40 grid h-11 w-11 place-items-center text-[#25D366] transition hover:scale-[1.08] active:scale-95 md:h-12 md:w-12 ${className}`}
        >
