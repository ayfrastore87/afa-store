        ...
        <main className="grid min-h-screen place-items-center bg-[#184D47] px-4 py-10 text-[#184D47]">
            <section className="relative z-10 w-full max-w-md">
                <div className="mb-7 text-center text-white">
                    <div className="mx-auto mb-4 grid h-24 w-24 place-items-center rounded-[28px] border border-[#C8A14A]/35 bg-white/95 p-3 shadow-2xl shadow-black/20">
                        <Image src="/assets/logo.svg" alt="AFA STORE logo" width={72} height={72} priority />
                    </div>
