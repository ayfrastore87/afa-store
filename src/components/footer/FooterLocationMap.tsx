...
export default function FooterLocationMap({ coordinates = null }: Props) {
    ...
    return <>
        <button type="button" onClick={() => setOpen(true)} aria-label="Lihat lokasi AFA STORE" className="relative block h-[110px] w-full max-w-[260px] overflow-hidden rounded-xl border border-[rgba(212,175,55,.28)] bg-[#0E2118] text-left sm:h-[105px]">
